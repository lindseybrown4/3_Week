...
angular.module('filteringApp').service('filteringService', function(){
...
// arrayApp.service('arrayService', function(){  //step 8
// 	this.getPeople = function(){   //step 9
// 		return myData;
// 	}; 

// 	this.people = myData; //experimental line step 10
